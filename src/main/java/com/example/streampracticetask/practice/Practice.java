...
public class Practice {
    ...
    public static List<Department> getAllDepartmentsWhichManagerFirstNameIsSteven() {
        //TODO Implement the method
        return departmentService.readAll().stream()
                .filter(department -> department.getManager().getFirstName()
                        .equals("Steven"))
                .collect(Collectors.toList());
    }
    ...
    public static boolean checkIfThereIsAnySalaryGreaterThan2000InITDepartment() {
        ...
        return employeeService.readAll().stream()
                ...
                .anyMatch(department -> department.getDepartmentName().equals("IT"));
        /**
    ...
    public static Integer getLongestNameLength() throws Exception {
        ...
        Employee employee = employeeService.readAll().stream()
                .reduce(((employee1, employee2) ->
                        employee1.getFirstName().length() + employee1.getLastName().length() >
...
//                   if (departmentId.equals(90L) || departmentId.equals(60L) || departmentId.equals(100L) ||
//                           departmentId.equals(120L) || departmentId.equals(130L)) {
//                       return employee;
//                   }else{
//                       return null;
//                   }
